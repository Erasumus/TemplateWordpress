<section class="section section-side-image section-light review-section-1">
	<div class="container">
		...
		<div class="review-slider-3">
			<?php 
			$i = 0;
			query_posts('posts_per_page=5&cat=6'); 
			if (have_posts()): while (have_posts()): the_post(); 
				get_template_part('loop/loop-reviews/loop-review-3'); 
			endwhile; 
			endif;
			?>
		</div>
		<ul class="controls" id="customize-controls-review-3" aria-label="Carousel Navigation" tabindex="0">
