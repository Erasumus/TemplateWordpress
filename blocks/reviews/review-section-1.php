<section class="section section-side-image section-light review-section-1">
	<div class="container">
		...
		<div class="review-slider-1">
			<?php 
			$i = 0;
			query_posts('posts_per_page=5&cat=6'); 
			if (have_posts()): while (have_posts()): the_post(); 
			get_template_part('loop/loop-reviews/loop-review'); 
			endwhile; 
			endif;
			?>
		</div>
		<ul class="controls" id="customize-controls-review" aria-label="Carousel Navigation" tabindex="0">
